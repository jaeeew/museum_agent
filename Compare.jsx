    ...
    return (
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            힌트: /ai/analyze-compare 라우트, GOOGLE_API_KEY, CORS 설정, 포트
            상태를 확인해 주세요.
          </p>
        </div>
      </div>
    ...
    >
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          ...
          >
            {loadingAlt ? "다른 조합 찾는 중..." : "다른 조합으로 비교하기"}
          </button>
        </div>
      </div>
    </div>
